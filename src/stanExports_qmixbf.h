...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_qmixbf");
    reader.add_event(70, 68, "end", "model_qmixbf");
    return reader;
}
...
class model_qmixbf : public prob_grad {
private:
        int N;
        int D;
        vector_d Y;
...
typedef model_qmixbf_namespace::model_qmixbf stan_model;
#endif
