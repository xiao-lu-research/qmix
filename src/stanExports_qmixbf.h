...
namespace model_qmixbf_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'qmixbf', line 29, column 2 to column 20)",
                                                      " (in 'qmixbf', line 30, column 2 to column 19)",
                                                      " (in 'qmixbf', line 37, column 2 to column 11)",
                                                      " (in 'qmixbf', line 39, column 4 to column 27)",
                                                      " (in 'qmixbf', line 38, column 16 to line 40, column 3)",
                                                      " (in 'qmixbf', line 38, column 2 to line 40, column 3)",
                                                      " (in 'qmixbf', line 45, column 6 to column 14)",
                                                      " (in 'qmixbf', line 47, column 8 to column 72)",
                                                      " (in 'qmixbf', line 46, column 20 to line 48, column 7)",
                                                      " (in 'qmixbf', line 46, column 6 to line 48, column 7)",
                                                      " (in 'qmixbf', line 49, column 6 to column 26)",
                                                      " (in 'qmixbf', line 44, column 18 to line 50, column 5)",
                                                      " (in 'qmixbf', line 44, column 4 to line 50, column 5)",
                                                      " (in 'qmixbf', line 52, column 6 to column 14)",
                                                      " (in 'qmixbf', line 54, column 8 to column 78)",
                                                      " (in 'qmixbf', line 53, column 20 to line 55, column 7)",
                                                      " (in 'qmixbf', line 53, column 6 to line 55, column 7)",
                                                      " (in 'qmixbf', line 56, column 6 to column 25)",
                                                      " (in 'qmixbf', line 51, column 18 to line 57, column 5)",
                                                      " (in 'qmixbf', line 51, column 4 to line 57, column 5)",
                                                      " (in 'qmixbf', line 59, column 4 to column 23)",
                                                      " (in 'qmixbf', line 43, column 16 to line 60, column 3)",
                                                      " (in 'qmixbf', line 43, column 2 to line 60, column 3)",
                                                      " (in 'qmixbf', line 17, column 2 to column 8)",
                                                      " (in 'qmixbf', line 18, column 2 to column 8)",
                                                      " (in 'qmixbf', line 19, column 26 to column 27)",
                                                      " (in 'qmixbf', line 19, column 2 to column 31)",
                                                      " (in 'qmixbf', line 20, column 9 to column 10)",
                                                      " (in 'qmixbf', line 20, column 11 to column 12)",
                                                      " (in 'qmixbf', line 20, column 2 to column 16)",
                                                      " (in 'qmixbf', line 21, column 2 to column 8)",
                                                      " (in 'qmixbf', line 22, column 9 to column 10)",
                                                      " (in 'qmixbf', line 22, column 2 to column 14)",
                                                      " (in 'qmixbf', line 23, column 2 to column 14)",
                                                      " (in 'qmixbf', line 29, column 17 to column 18)",
                                                      " (in 'qmixbf', line 29, column 9 to column 10)",
                                                      " (in 'qmixbf', line 30, column 10 to column 11)",
                                                      " (in 'qmixbf', line 4, column 4 to column 14)",
                                                      " (in 'qmixbf', line 8, column 6 to column 36)",
                                                      " (in 'qmixbf', line 7, column 11 to line 9, column 5)",
                                                      " (in 'qmixbf', line 6, column 6 to column 31)",
                                                      " (in 'qmixbf', line 5, column 14 to line 7, column 5)",
                                                      " (in 'qmixbf', line 5, column 4 to line 9, column 5)",
                                                      " (in 'qmixbf', line 10, column 4 to column 17)",
                                                      " (in 'qmixbf', line 3, column 29 to line 11, column 3)"};
...
class model_qmixbf final : public model_base_crtp<model_qmixbf> {
private:
  int N;
  int D;
...
public:
  ...
  inline std::string model_name() const final { return "model_qmixbf"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_qmixbf(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_qmixbf_namespace::model_qmixbf";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_qmixbf_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_qmixbf_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_qmixbf_namespace::model_qmixbf;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_qmixbf_namespace::profiles__;
}
#endif
#endif
