...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_qmixbrv");
    reader.add_event(78, 76, "end", "model_qmixbrv");
    return reader;
}
...
class model_qmixbrv : public prob_grad {
private:
        int N;
        int D;
        vector_d Y;
...
typedef model_qmixbrv_namespace::model_qmixbrv stan_model;
#endif
